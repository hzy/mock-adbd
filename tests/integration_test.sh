...
# --- Start QEMU ---
echo ""
echo "[2/8] Starting QEMU VM (port $ADB_PORT)..."
QEMU_ARGS=(
    qemu-system-x86_64
...
echo ""
echo "[4/8] Exit code propagation..."
...
echo ""
echo "[7/8] Concurrent connections..."
...
echo ""
echo "[8/8] Rapid sequential commands..."
ALL_OK=true
for i in $(seq 1 5); do
